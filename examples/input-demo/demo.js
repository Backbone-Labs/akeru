...
document
  ...
  .addEventListener('click', () => provider.showControls());
document
  .querySelector('#hide-settings')
  .addEventListener('click', () => provider.hideControls());
provider.start();
