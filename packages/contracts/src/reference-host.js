...
export function planLaunch(manifest, { grants, graphics, features, shellOrigin, titleOrigin, sdkVersion = SDK_VERSION }) {
  ...
  const csp = "default-src 'none'; script-src 'self' 'wasm-unsafe-eval'; style-src 'self'; img-src 'self' data:; media-src 'self'; font-src 'self'; connect-src 'self'; object-src 'none'; base-uri 'none'; form-action 'none'; frame-src 'none'; worker-src 'none'; frame-ancestors " + shellOrigin;
  ...
  return Object.freeze({ renderer, sdkVersion, titleOrigin, sandbox: 'allow-scripts allow-same-origin', headers: Object.freeze({
...
export { assertTitleAdapterV1, createReferenceHost } from './reference-session.js';
